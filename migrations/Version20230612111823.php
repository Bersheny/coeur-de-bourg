 ...
 */
final class Version20230612111823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_users CHANGE role role JSON NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_users CHANGE role role LONGTEXT NOT NULL');
    }
}
